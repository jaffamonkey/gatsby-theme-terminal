...
<Alert variant='secondary' mb={2}>[Shift left](https://en.wikipedia.org/wiki/Shift-left_testing) is about implementing quality checks earlier in development cycle, including design and requirements.</Alert>
...
<Alert variant='secondary' mb={2}>Quality at all stages in project pipeline needs regular reivew; and most importantly, the team should feel they can be honest.</Alert>
