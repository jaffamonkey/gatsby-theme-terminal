...
<Message variant='secondary' mb={5}>Implement quality checks earlier in development cycle, including design and requirements stages</Message>
...
<Message variant='success' mb={5}>Tests belong in the CI/CD pipelines</Message>
