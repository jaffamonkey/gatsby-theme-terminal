...
- Within a hour, I can do a test framework proof of concept
- Within a day, I can have a test framework demo running
- Within a week, I can have test framework running on CI
- Within a month, I can have performance tests running on CI.
- Within 3 months, I can completely turn around quality processes
- Within 6 months ... well, hopefully you would never need me that long.
</Message>
<Divider />
